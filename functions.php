...
function acstarter_setup() {
	...
	// This theme uses wp_nav_menu() in a bunch of locations
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'acstarter' ),
		'charlotte' => esc_html__( 'Charlotte', 'acstarter' ),
		'gaston' => esc_html__( 'Gaston', 'acstarter' ),
		'lakenorman' => esc_html__( 'Lake Norman', 'acstarter' ),
		'northeast' => esc_html__( 'North East', 'acstarter' ),
		'southcarolina' => esc_html__( 'South Carolina', 'acstarter' ),
		'southcharlotte' => esc_html__( 'South Charlotte', 'acstarter' ),
		'southeastcharlotte' => esc_html__( 'Southeast Charlotte', 'acstarter' ),
